...
import random
random.seed(123)
from videocombined_model import AudioVisual,TrainingModel
...
def noice_image_and_wav_loader(paths,audio_dataset_path,video_dataset_path,musan_path,musan_dict):
    ...
    for path in paths:
        ...
        try:
            ...
            print("img load fail")
            audios.append(torch.zeros((48000)))
            images.append(torch.zeros((75, 3, 112, 112)))
            continue
        image = image / 255
...
model_path = "training9/checkpoint1.pt"
...
training_model  = TrainingModel({"audio_string":"avg_model.pt","video_string":None,"joint_training":False,"frame_fusion":False},number_of_people=1209)
...
for i in range(0,len(all_paths),batch_size):
    ...
    # output = noice_image_and_wav_loader(all_paths[i:j],audio_dataset_path,video_dataset_path,musan_path,id_2_musan)
